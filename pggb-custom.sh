...
mash_nmap_short_seq=$MASH_NMAP_SHORT_SEQ
...
if [ "$show_help" == true ]; then
    ...
    echo "        --mash-nmap-short-seq N  mappings for sequences shorter than segment length [default: "$MASH_NMAP_SHORT_SEQ"]"
    echo "   [seqwish]"
...
paf_spec=$mapper_letter-s$segment_length-l$block_length-p$map_pct_id-n$n_mappings-S$mash_nmap_short_seq-K$mash_kmer-F$mash_kmer_thres-x$sparse_map-g$hg_filter_ani_diff
...
$mapper:
  ...
  mash-nmap-short-seq: $mash_nmap_short_seq
